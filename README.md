...
Daybook is a full-stack diary application built with a Hono + TypeScript
backend and a Next.js + React frontend. The repository also includes product
requirements, technical specifications, and agent-oriented review guidance for
development workflows.

## Demo

The repository does not include a screen recording yet, but the core user flow
is designed around the following experience:
...
- Add a demo video, screenshots, or architecture diagrams if the repository is
  going to be shared more broadly.
...
No `LICENSE` file is currently included in this repository. Define the license
or internal distribution policy before sharing it outside the intended team.
